 ...
 * @lucene.experimental
 */
public final class XLucene95HnswVectorsFormat extends KnnVectorsFormat {
    ...
    public XLucene95HnswVectorsFormat() {
     ...
     */
    public XLucene95HnswVectorsFormat(int maxConn, int beamWidth) {
    ...
    public String toString() {
        return "XLucene95HnswVectorsFormat(name=XLucene95HnswVectorsFormat, maxConn="
                + maxConn
                + ", beamWidth="
                + beamWidth
                + ")";
